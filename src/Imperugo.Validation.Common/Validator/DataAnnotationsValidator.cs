namespace Imperugo.Validation.Common.Validator
{
	...
	public class DataAnnotationsValidator : IObjectValidator
	{
		...
		/// </summary>
		/// <param name="object">The object.</param>
		/// <exception cref="ImperugoValidatorException">For each properties that doesn't respect the Data Annotations.</exception>
		public void Validate(object @object)
		{
			if (@object == null)
			{
				throw new ImperugoValidatorException("The parameter must not be null.", "object");
			}
			...
			if (!isValid)
			{
				...
				throw new ImperugoValidatorException(result.ErrorMessage, result.MemberNames.FirstOrDefault());
			}
		}
